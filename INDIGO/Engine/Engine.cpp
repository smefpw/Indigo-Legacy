...
//[junk_enable /]
	...
	void ClanTag()
	{
		...
		case 3:
		{
			SetMyClanTag("SMEF.PW \r", "SMEF.PW only");
			break;
		}
		case 4:
		{
	...
	{
		std::vector<std::string> chatspam = { "smef.pw | Creator of Smef.pw's Indigo" };
	...
	void ChatSpamRandom()
	{
		std::vector<std::string> chatspamsss = { "smef.pw | Creator of Smef.pw's Indigo" , "I'm legit stfu coon" , "I USE SMEF.PW'S INDIGO","SMEF.PW'S INDIGO" };
